...
class GradientBackground {
  constructor(sceneManager) {
    ...
    this.uniforms = {
      ...
      uColor1: { value: new THREE.Vector3(0.667, 0.122, 0.141) }, // AA1F24
      uColor2: { value: new THREE.Vector3(0.973, 0.945, 0.906) }, // F8F1E7
      uColor3: { value: new THREE.Vector3(0.667, 0.122, 0.141) }, // AA1F24
      uColor4: { value: new THREE.Vector3(0.667, 0.122, 0.141) }, // AA1F24
      uColor5: { value: new THREE.Vector3(0.667, 0.122, 0.141) }, // AA1F24
      uColor6: { value: new THREE.Vector3(0.667, 0.122, 0.141) }, // AA1F24
      uSpeed: { value: 0.6 }, // Faster animation
      uIntensity: { value: 0.5 },
      uTouchTexture: { value: null },
      uGrainIntensity: { value: 0.08 },
      uZoom: { value: 1.0 }, // Zoom/scale control - lower = less zoomed (more visible)
      uAidaRed: { value: new THREE.Vector3(0.667, 0.122, 0.141) }, // #AA1F24 - Aida Red base color
      uGradientSize: { value: 1.0 }, // Control gradient size (smaller = more gradients)
      uGradientCount: { value: 6.0 }, // Number of gradient centers
      uColor1Weight: { value: 1.0 }, // Weight for color1 - reduce for more background color
      uColor2Weight: { value: 1.0 } // Weight for color2 - increase for more background color
    };
  }
    ...
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
            ...
            vec3 getGradientColor(vec2 uv, float time) {
              ...
              color = mix(uAidaRed, color, mixFactor1);
            ...
            void main() {
              ...
              color = mix(uAidaRed, color, mixFactor2);
...
class App {
  constructor() {
    ...
    this.scene.background = new THREE.Color('#AA1F24'); // Aida Red
    ...
    this.colorSchemes = {
      1: {
        // Aida Beige + Aida Red
        color1: new THREE.Vector3(0.973, 0.945, 0.906), // F8F1E7 - Aida Beige
        color2: new THREE.Vector3(0.667, 0.122, 0.141) // AA1F24 - Aida Red
      },
      2: {
        // Turquoise + Coral Red-Orange
        color1: new THREE.Vector3(1.0, 0.424, 0.314), // FF6C50 - Coral Red-Orange
        color2: new THREE.Vector3(0.973, 0.945, 0.906) // 40E0D0 - Turquoise
      },
      3: {
      ...
      5: {
        ...
        color3: new THREE.Vector3(0.973, 0.945, 0.906), // F8F1E7 - Aida Beige
        color4: new THREE.Vector3(0.0, 0.0, 0.0), // 000000 - Black
        color5: new THREE.Vector3(0.973, 0.945, 0.906), // F8F1E7 - Aida Beige
  ...
  setColorScheme(scheme) {
    ...
    if (scheme === 3) {
      ...
      uniforms.uColor1.value.copy(colors.color1); // F8F1E7 - Aida Beige
      uniforms.uColor2.value.copy(colors.color2); // 004238 - Dark Teal
      uniforms.uColor3.value.copy(colors.color3); // F8F1E7 - Aida Beige
      uniforms.uColor4.value.copy(colors.color4); // 000000 - Black
      uniforms.uColor5.value.copy(colors.color5); // F8F1E7 - Aida Beige
    ...
    if (scheme === 1) {
      this.scene.background = new THREE.Color('#AA1F24'); // Navy blue for scheme 1
      uniforms.uAidaRed.value.set(0.667, 0.122, 0.141); // #AA1F24 - Aida Red base color
      ...
      this.scene.background = new THREE.Color('#AA1F24'); // Navy blue (same as scheme 1)
      uniforms.uAidaRed.value.set(0.667, 0.122, 0.141); // #0a0e27 - Navy blue base color (same as scheme 1)
      ...
      this.scene.background = new THREE.Color('#AA1F24'); // Navy blue (same as scheme 6)
      uniforms.uAidaRed.value.set(0.667, 0.122, 0.141); // #0a0e27 - Navy blue base color (same as scheme 6)
      ...
      this.scene.background = new THREE.Color('#AA1F24'); // Navy blue for scheme 8
      uniforms.uAidaRed.value.set(0.667, 0.122, 0.141); // #0a0e27 - Navy blue base color
      // More gradient action: smaller gradients, more of them
      uniforms.uGradientSize.value = 0.45; // Smaller gradient radius for more defined gradients
      uniforms.uGradientCount.value = 12.0; // More gradient centers (12 instead of 6)
      uniforms.uSpeed.value = 1.5; // Slightly faster for more movement
      ...
      this.scene.background = new THREE.Color('#AA1F24'); // Navy blue for scheme 5 (same as scheme 1)
      uniforms.uAidaRed.value.set(0.667, 0.122, 0.141); // #0a0e27 - Navy blue base color (same as scheme 1)
      // More gradient action: smaller gradients, more of them (same as scheme 1)
      uniforms.uGradientSize.value = 0.45; // Smaller gradient radius for more defined gradients
      uniforms.uGradientCount.value = 12.0; // More gradient centers (12 instead of 6)
      ...
      uniforms.uAidaRed.value.set(0, 0, 0); // #FAFAFA - Off-white base
    } else if (scheme === 2) {
      this.scene.background = new THREE.Color('#AA1F24'); // Default dark navy for scheme 2
      uniforms.uAidaRed.value.set(0.667, 0.122, 0.141); // #0a0e27 - Default dark navy
      ...
      this.scene.background = new THREE.Color('#AA1F24'); // Default dark navy
      uniforms.uAidaRed.value.set(0.667, 0.122, 0.141); // #0a0e27 - Default dark navy
      uniforms.uGradientSize.value = 1.0; // Default size
      uniforms.uGradientCount.value = 6.0; // Default count
      uniforms.uSpeed.value = 1.2; // Default speed
